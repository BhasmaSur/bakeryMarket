          ...
          {quantity !== 0 && (
            <>
              <button
                ...
                disabled={quantity <= 0}
                id="incrementBtn"
                class="px-2 py-0.5 sm:px-3 sm:py-2 bg-blue-500 text-white rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
              >
                -
              </button>
